          ...
          <div>
            ...
            <a href=signin-one.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Signin One') }}
                </span>
              </div>
            </a>
            <a href=signin-two.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Signin Two') }}
                </span>
              </div>
            </a>
            <a href=signin-three.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Signin Three') }}
                </span>
              </div>
            </a>
            <a href=signup-one.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Signup One') }}
                </span>
              </div>
            </a>
            ...
            <a href=signup-three.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Signup Three') }}
                </span>
              </div>
            </a>
            ...
            <a href=lock-screen-one.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Lock Screen One') }}
                </span>
              </div>
            </a>
            <a href=lock-screen-two.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Lock Screen Two') }}
                </span>
              </div>
            </a>
          ...
          <div>
            ...
            <a href=typography.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Typography') }}
                </span>
              </div>
            </a>
            <a href=colors.html>
            ...
            <a href=progress-bar.html>
              <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                ...
                <span
                  class="capitalize text-slate-600 dark:text-slate-300">{{ __('Progress Bar') }}
                </span>
              </div>
            </a>
