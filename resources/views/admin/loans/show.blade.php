                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="flex items-center gap-4">
                                @if ($loan->doc_front_url)
                                    <img src="{{ $loan->doc_front_url }}"
                                        class="h-24 w-40 object-contain border rounded" />
                                @endif
                                @if ($loan->doc_back_url)
                                    <img src="{{ $loan->doc_back_url }}" class="h-24 w-40 object-contain border rounded" />
                                @endif
                            </div>
                        </div>
                        ...
                        @if ($loan->deposit_screenshot_url)
                            <div class="col-span-2">
                                <div class="text-xs text-slate-500 mb-1">Screenshot</div>
                                <img src="{{ $loan->deposit_screenshot_url }}"
