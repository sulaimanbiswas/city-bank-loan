            ...
            <div class="card col-span-12 lg:col-span-12">
                <div class="card-body flex flex-col p-6">
                    <header class="flex items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                        <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">Edit Plan</div>
                        </div>
                    </header>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                ...
                                <div class="input-area">
                                    ...
                                    <select id="select" class="form-control" name="type">
                                        @php($current = old('type', $plan->types))
                                        <option value="amount" class="dark:bg-slate-700" @selected($current === 'amount')>Amount
                                        </option>
                                        <option value="duration" class="dark:bg-slate-700" @selected($current === 'duration')>
                                            Duration</option>
                                        <option value="reason" class="dark:bg-slate-700" @selected($current === 'reason')>Reason
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="input-area relative ">
                                    ...
                                    <input type="text" name="value" value="{{ old('value', $plan->value) }}"
                                ...
                                <div class="input-area relative ">
                                    ...
                                    <input type="number" step="0.01" name="interest_rate"
                                        value="{{ old('interest_rate', $plan->interest_rate) }}" class="form-control"
