            ...
            <form method="POST" action="{{ route('register') }}" class="bg-white rounded shadow p-4">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                        :value="old('name')" required autofocus autocomplete="name" placeholder="আপনার নাম" />
                ...
                <!-- Phone -->
                <div class="mt-4">
                    <x-input-label for="phone" value="মোবাইল নম্বর" />
                    <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone"
                        :value="old('phone')" required autocomplete="tel" placeholder="01XXXXXXXXX" />
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <x-primary-button
                        class="ms-4 bg-[#ff0000] hover:bg-red-700 focus:bg-red-700 active:bg-red-800 border-0">
                        রেজিস্টার
                    </x-primary-button>
                </div>
            </form>
